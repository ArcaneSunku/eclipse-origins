...
&emsp; This build, nicknamed _Solar Eclipse_, is version `4.4.0.0-alpha`.
...
So, Solar Eclipse (`v4`) is currently using Model `v4`, Controller `v0`, View `v0`, and is in its `alpha` milestone.
