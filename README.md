...
&emsp; This build, nicknamed _Solar Eclipse_, is version `4.3.3.1-alpha`.
...
So, Solar Eclipse (`v4`) is currently using Model `v3`, Controller `v3`, View `v1`, and is in its `alpha` milestone.
